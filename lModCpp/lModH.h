...
struct modParms {
	...
	int tr = 7; double sf1 = 1; double sf2 = 1; double sf3 = 1; double sf4 = 1; double sf5 = 1; double sf6 = 1; double sf7 = 1; double sf8 = 1; double sf9 = 1; double sf10 = 1; double dt = 0.25; double n = 50; double Emax = 93.6;
	double E0 = 177; double L0 = 8; double P0 = 1; double M0 = 7; double z1 = 1; double z2 = 1; double z3 = 1; double z4 = 1; double z5 = 1; double z6 = 1; double z7 = 1; double z8 = 1; double z9 = 1; double z10 = 1; double B = 21.19;
